...
const Demo = (() => {
  ...
  const EXPENSES = [
    ...
    _e('demo-008', '2026-04-22T11:00:00Z', '田中 太郎', 'tanaka@example.com',
       '交通費', '2026-04-22', '新宿→品川（往復）', 760, '旅費交通費', '社内研修参加', true, '', '', '2026-05-10'),
    ...
    _e('demo-013', '2026-03-15T16:00:00Z', 'デモ ユーザー', 'demo@example.com',
       '交通費', '2026-03-15', '東京→名古屋（新幹線往復）', 27000, '旅費交通費', '取締役会出席', true, '', '', '2026-04-10'),
    ...
    _e('demo-021', '2026-01-15T09:00:00Z', 'デモ ユーザー', 'demo@example.com',
       '交通費', '2026-01-15', '渋谷→池袋（往復）', 580, '旅費交通費', '新年挨拶回り', true, '', '', '2026-02-10'),
