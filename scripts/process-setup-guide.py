...
STEPS = [
    ...
    {   # step04: URL確認（チーム名y=644-655, URL y=695-703, URLスラグy=926-948）
        'src': '4172d526-1000003452.png',
        'out': 'step04.png',
        'blur': [
            (0, 625, 840, 730),                  # チーム名（y=628-712）+ URL行（y=695-712）まとめてぼかし
            (0, 910, 864, 960),                  # URLスラグ入力欄 test-k（実測y=926-948）
        ],
        'hl':   [(28, 1258, 410, 1330),          # URLを入力するボタン（実測x=28-411, y=1266-1328）
                 (412, 1258, 650, 1330)],        # このまま続けるボタン（実測x=412-650, y=1266-1328）
    },
