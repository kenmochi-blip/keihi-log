...
STEPS = [
    ...
    {   # step07: 新しいキー作成ダイアログ（実測: ボタン行y=1082-1100）
        'src': '5be52da8-1000003455.png',
        'out': 'step07.png',
        'blur': [],
        'hl':   [(440, 1073, 820, 1110)],        # キーを作成ボタン（実測: 右ボタンy=1082-1100）
    },
    {   # step08: APIキー詳細（実測: API key行y=584-600, コピーアイコンx=754-770）
        'src': '8403d5ad-1000003456.png',
        'out': 'step08.png',
        'blur': [
            (28, 572, 748, 615),                 # APIキー文字列（実測y=584-600）
            (28, 778, 700, 822),                 # プロジェクト名（実測y=790-810）
            (28, 942, 700, 982),                 # プロジェクト番号（実測y=955-970）
        ],
        'hl':   [(748, 572, 836, 615)],          # コピーアイコン（実測x=754-770, y=580-600）
    },
    ...
    {   # step11: セットアップ完了（実測: 青「アプリを開く」y=1660-1819, QRy=1012-1318）
        ...
        'out': 'step11.png',
        'blur': [
            (0, 632, 864, 700),                  # チームURL（実測y=645=border, y=650=text）
