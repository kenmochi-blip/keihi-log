...
const Demo = (() => {
  ...
  const EXPENSES = [
    // ── 2026-06 ──
    _e('demo-j01', '2026-06-09T09:00:00Z', 'デモ ユーザー', 'demo@example.com',
       '領収書', '2026-06-09', 'ルノアール 新宿店', 1080, '会議費', '取引先との打ち合わせ', false, ''),
    _e('demo-j02', '2026-06-06T14:00:00Z', '田中 太郎', 'tanaka@example.com',
       '電車/バス', '2026-06-06', '東京→横浜（往復）', 940, '旅費交通費', '顧客訪問', false, ''),
    _e('demo-j03', '2026-06-04T10:30:00Z', '佐藤 次郎', 'sato@example.com',
       '領収書', '2026-06-04', 'ヨドバシカメラ', 4290, '消耗品費', 'SDカード・USBメモリ', false, 'T1000000000001'),
    _e('demo-j04', '2026-06-02T11:00:00Z', '鈴木 花子', 'suzuki@example.com',
       '領収書', '2026-06-02', 'アスクル', 2640, '消耗品費', '6月オフィス備品補充', false, ''),
    // ── 2026-05 ──
