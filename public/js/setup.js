    ...
    const updates = [
      // 経費一覧ヘッダー（21列）
      {
        ...
        values: [[
          ...
          'インボイス番号', 'AI解析額', '画像ハッシュ(SHA256)', '申請者Email', 'ID', 'デバイス情報', '税区分', '源泉徴収', 'カスタムフラグ'
        ]]
      },
      // 修正履歴ヘッダー（経費一覧の列を継承、変更前/後の2行セット）
      {
        range: '修正履歴!A1:X1',
        values: [['修正日時', '修正者Email', '区分',
          '申請日時', '申請者名', 'タイプ', '日付', '支払先', '金額',
          '勘定科目', '備考', '証票', '確認', 'AI監査', '精算日',
          'インボイス番号', 'AI解析額', '画像ハッシュ(SHA256)', '申請者Email', 'ID', 'デバイス情報', '税区分', '源泉徴収', 'カスタムフラグ'
        ]]
      ...
      // マスタ表ヘッダー・初期管理者・デフォルト勘定科目・支払元
      {
        range: 'マスタ表!A1:H14',
        values: [
          ['氏名', 'メールアドレス', '所属', '権限',  '備考',       '会社払い支払元',         '勘定科目', 'カスタムフラグ'],
