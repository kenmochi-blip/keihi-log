---
title: "LINEだけで経費精算が完結するサービスは他にある？9社を調べてみた"
...
<tr><td>freee経費精算</td><td>部分対応</td><td class="wrap">公式LINEアカウントに領収書を送ると電子帳簿保存用にfreeeへ保存される「LINEレシート電子保存」を提供（2023年12月〜）。2024年5月からは税理士と顧問先のグループチャットでの証憑アップロードにも対応。ただしLINEはあくまで証憑をfreeeへ送る入口で、読み取り内容の確認・仕訳化はfreeeの画面で行う。経費の申請・承認ワークフローとは別物</td></tr>
